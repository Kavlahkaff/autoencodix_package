...
ontology_folder = "./data/llm_ontologies/output_llms/task-oriented"

# ontology_files = [f for f in os.listdir(ontology_folder) if f.endswith('ontology.json')] # exclude "_with_genes" files
ontology_files = [f for f in os.listdir(ontology_folder) if f.endswith('ontology_task.json')] # exclude "_with_genes" files
...
final_folder = "./data/llm_ontologies/final_ontologies/task-oriented"
